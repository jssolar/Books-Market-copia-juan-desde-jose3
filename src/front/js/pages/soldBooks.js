              ...
              <div className="card-body pt-0 mt-0 d-block justify-content-center">
                <div style={{ height: "110px" }}>
                  <p className="text-center m-1">
                    <b>{venta.book.title}</b>
                  </p>
                  <p className="text-center text-capitalize mb-1">
                    {venta.book.author}
                  </p>
                  <p className="text-center  mb-3">{venta.book.price}</p>
                  <p className="text-center  mb-3">{venta.seller.name}</p>
                </div>
                <div className="d-flex justify-content-center">
                  <Link
                    to={`/mySoldDetails/${venta.book.id}`}
