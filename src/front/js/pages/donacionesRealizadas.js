    ...
    <div className="container-fluid">
      ...
      <div className="shadow-sm d-flex m-3 justify-content-between border rounded ">
        <div className="ms-0">
          <img
            className="rounded"
            src="https://www.elquintopoder.cl/wp-content/uploads/2020/06/WhatsApp-Image-2019-04-03-at-15.16.24-723x364.jpeg"
            alt="..."
      ...
      <div className="shadow-sm d-flex m-3 justify-content-between border rounded ">
        ...
        <div className="me-0">
          <img
            className="rounded"
            src="https://pbs.twimg.com/media/D4XJrAHWsAAgp4A.jpg"
            alt="..."
      ...
      <div className="shadow-sm d-flex m-3 justify-content-between border rounded ">
        <div className="ms-0">
          <img
            className="rounded"
            src="https://i0.wp.com/www.sanjoseahora.com.uy/wp-content/uploads/2020/04/escuela-2-rinc%C3%B3n-del-pino.png?resize=750%2C452&ssl=1"
            alt="..."
            style={{ width: "px", height: "400px" }}
          />
        </div>
